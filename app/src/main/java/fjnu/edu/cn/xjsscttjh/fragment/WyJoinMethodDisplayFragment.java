 ...
 * 网易彩票玩法介绍显示页面
 */
@ContentView(R.layout.fragment_wy_join_method_display)
public class WyJoinMethodDisplayFragment extends AppBaseFragment{
    ...
    private void loadData(){
        ...
        Observable.create(new ObservableOnSubscribe<String>() {
            ...
            public void subscribe(ObservableEmitter<String> e) throws Exception {
                e.onNext(LottyDataGetUtils.getJoinMethodByWY(mUrl));
            }
